...
<head>
    ...
    <style>
        :root {
            --branet-primary: #1e3a8a;    /* Azul escuro profissional */
            --branet-secondary: #0ea5e9;  /* Azul claro */
            --branet-accent: #f59e0b;     /* Laranja/dourado para destaques */
            --branet-dark: #1f2937;       /* Cinza escuro para textos */
            --branet-light: #f8fafc;      /* Fundo claro */
        }
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-branet" href="#">QUEM SOMOS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-branet" href="#">SOLUÇÕES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-branet" href="#">CONTATO</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="hero-section">
        <div class="container text-center">
            ...
            <p class="hero-subtitle">Sistema de gerenciamento de documentos desenvolvido com as melhores práticas de tecnologia e segurança empresarial.</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="text-muted">Selecione uma categoria para começar a gerenciar seus arquivos com eficiência e segurança.</p>
        </div>
                ...
                <a href="/categorias" class="text-decoration-none">
                    <div class="card card-branet p-4">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text-branet">Gerencie departamentos e tipos de documentos com organização inteligente.</p>
                ...
                <a href="/documentos" class="text-decoration-none">
                    <div class="card card-branet p-4">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text-branet">Controle versões, visualize e gerencie todos os arquivos da empresa.</p>
                            <span class="text-primary fw-medium">Acessar <i class="bi bi-arrow-right"></i></span>
                        </div>
                    </div>
                </a>
                ...
                <a href="/documentos/create" class="text-decoration-none">
                    <div class="card card-branet p-4">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text-branet">Envie documentos PDF, imagens ou DOCX com segurança e rapidez.</p>
                            <span class="text-primary fw-medium">Acessar <i class="bi bi-arrow-right"></i></span>
                        </div>
                    </div>
                </a>
                ...
                <div class="alert alert-info border-0 bg-light" style="border-left: 4px solid var(--branet-primary);">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Todos os documentos são armazenados com criptografia de ponta a ponta, garantindo conformidade com LGPD e regulamentações do setor.</p>
                        </div>
                    </div>
                </div>
            </div>
